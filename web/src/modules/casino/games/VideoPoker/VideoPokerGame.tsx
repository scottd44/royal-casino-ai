...
import { videoPokerSounds } from './sounds'
    ...
    (finalHand: HandCard[]) => {
      ...
      if (result) {
        ...
        if (net > 0) {
          ...
          if (result.pay >= 25) videoPokerSounds.bigwin()
          else videoPokerSounds.win()
        } else {
